...
function Footer() {
  return (
    <>
      ...
      <div className='bg-red-400 h-auto flex flex-col  px-5 py-5 sm:flex-row'>
        <p className='text-[#370617] sm:w-2/4 flex justify-center items-center sm:justify-start'>2024 © Akash Kumar Tiwary</p>
        <div className='flex sm:w-2/4 justify-evenly mt-2 mb-1'>
        <li className= 'text-[#370617] list-none px-1 hover:scale-125 hover:text-[#dc2f02] transition-all'><a target='_blank' 
